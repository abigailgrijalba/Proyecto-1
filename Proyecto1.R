...
setwd("C:/Users/abbyg/Desktop/Procesamiento de datos geográficos")
datos <- read.csv("liberia_datos_climaticos.csv", na.strings = "", sep = ",", dec = ",")

# Ahora bien, con el comando  head y dim se van ver los datos generales de el archivo como los encabezados, las dimensiones y el tipo de archivo que es un data.frame
head(datos)
dim(datos)
class(datos)
